import type { LiveSimulationData } from "@/types/simulation";

export const liveSimulationData: LiveSimulationData = {
  ...
  activity: [
    ...
    },
    {
      ...
      description: "Tunde accepted delivery after conditional discount.",
      timestamp: "12:32 PM",
      tone: "success",
    },
    {
      ...
      description: "Zainab asked if checkout has discount proof and delivery assurance.",
      timestamp: "12:34 PM",
      tone: "neutral",
    },
  ],
